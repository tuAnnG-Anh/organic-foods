...
const Google = () => {
  return (
    <ButtonCustom
      className={"h-fit p-0  border-none"}
      title={
        <div className="flex w-50 h-15 bg-black-900 text-white rounded-[7px] items-center justify-center cursor-pointer">
          <div className="mr-3">
...
const AppStore = () => {
  const renderContent = () => {
    ...
    return (
      <div className="flex w-50 h-15 bg-black-900 text-white rounded-[7px] items-center justify-center">
        <div className="mr-3">
          <svg viewBox="0 0 384 512" width="30">
            <path
              fill="currentColor"
  ...
  return <ButtonCustom className={"h-fit p-0 border-none"} title={renderContent()} />
}
